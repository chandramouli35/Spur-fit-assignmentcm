            ...
            <div className="rounded-2xl bg-white  pt-8 max-w-[30rem] shadow-lg">
              ...
              <div className="flex flex-col gap-3 p-4">
                ...
                <p className="font-normal">
                  At ahead our goal is to make self-improvement fun and lasting.We know there's 
                  a way to make it work. And that's what
                  aHead is all about!
                </p>
              </div>
            ...
            {[...Array(6)].map((val, index) => (
              ...
              >
                ...
                <p className="font-normal">
                 ...
                 whatever stands in the way, be it bad habits, fears, etc.
                </p>
              </div>
            ))}
          </div>
